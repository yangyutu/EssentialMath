...
![img](affineTheory.png)

然后本书给出此定理在多元高斯随机变量加和中的应用。值得一提的是， 作者用脚注强调jointly normal这一重要条件。

<img src="affineCorollary.png" alt="img" style="zoom:90%;" />
...
<img src="machineLearningUnify.png" alt="img" style="zoom: 75%;" />
...
<img src="valueIterationTheory.png" alt="img" style="zoom:80%;" />

之后作者给出基于value iteration的算法。

![img](valueIterationAlg.png)
