...
\usepackage{multirow}
%\usepackage{biblatex}
\usepackage[backend=bibtex,style=nature,sorting=none,refsection=chapter]{biblatex}
\usepackage{hyperref}
\hypersetup{
	colorlinks = true,
	citecolor=blue,
...
\fancyfoot[RO, LE]{\slshape Essentials of Mathematical Methods, v.3.0}}
\pagestyle{fancy}
\fancyhf{}
...
%        }{https://github.com/yangyutu/NotesOnMathMethods}\\
       ...
       version 3.0 \\
\vspace{0.4cm}
        	\includegraphics[width=0.7\linewidth]{hopf_fibration}
       \vspace{0.4cm} 
